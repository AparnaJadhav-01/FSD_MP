...
def listingfun(request):
  ...
  return render(request, 'apts/listing.html', context)


def listinggo(request,listing_title):
  # listing_title='Isha Co-op'
  ...
  is_fav=False
  post=get_object_or_404(Listing,title=listing_title)
